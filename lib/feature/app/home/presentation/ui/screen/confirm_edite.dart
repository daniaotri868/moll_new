...
import 'final_edite.dart';

class EditeOrderScreen extends StatefulWidget {
  String id;
  static String name = "EditeOrderScreen";

   EditeOrderScreen({super.key,required this.id});

  @override
  State<EditeOrderScreen> createState() => _EditeOrderScreenState();
}

class _EditeOrderScreenState extends State<EditeOrderScreen> {
  List<Map> products=[];
    ...
    return BlocBuilder<HomeBloc, HomeState>(
      builder: (context, state) {
        ...
        return Scaffold(
          appBar:   AppBar(
            toolbarHeight: 90,
            title: AppText("تعديل السلة",              style: context.textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold,color: context.colorScheme.primary),
            ),
            centerTitle: true,
              ...
              children: [
                ...
                AppElevatedButton(
                  ...
                  context.read<HomeBloc>().add(
                      UpdateOrderEvent(createOrderParams: UpdateOrderParams(
