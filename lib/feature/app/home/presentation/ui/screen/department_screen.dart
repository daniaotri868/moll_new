...
class DetailsScreen extends StatefulWidget {
  ...
  const DetailsScreen({Key? key,this.idMoll}) : super(key: key);
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<HomeBloc>().add(AllDepartmentEvent(detailsParams:DetailsParams (id: widget.idMoll??"",userId: 'adac2042-2519-4ee9-bb52-0e01300d0aa0')));
